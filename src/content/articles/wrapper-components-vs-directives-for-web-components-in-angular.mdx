...
**Wrappers allow give you control and flexibility** — the component is used the way you want to use it. You can reshape, patch, and orchestrate. You can give consumers an Angular-idiomatic experience even when the underlying design system isn't.
